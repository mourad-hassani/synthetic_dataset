...
def create_dataset():
    """
    Read HealthCareMagic-100k.json file and generate preprocessed_questions_HealthCareMagic-100k.json file that contains a list of dictionaries of the form : 
    {"input": "input text", "expression": "extracted temporal expression", "value": "temporal annotation"}
    """
