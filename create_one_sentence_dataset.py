...
def create_one_sentence_dataset():
    """
    Read HealthCareMagic-100k.json file and generate one_sentence/one_sentence.json file that contains a list of dictionaries of the form : 
    {"input": "input sentence (just one sentence)", "expression": "extracted temporal expression", "value": "temporal annotation"}
    """
